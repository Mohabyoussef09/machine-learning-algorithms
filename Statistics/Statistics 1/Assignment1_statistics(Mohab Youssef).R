...
# this file i use mean and varience of absolute change as wanted from assignment
...
#mean of DS1 of absolute change
mean_DS1=0
old_data=DS1[1]
for(i in 1:len_DS1)
{
  mean_DS1=mean_DS1+(DS1[i]-old_data)
  old_data=DS1[i]
  
}
mean_DS1=mean_DS1/len_DS1
print(paste("Mean DS1 of absolute change=",mean_DS1))
#mean_DS1=mean(DS1) -->mean using built in function

#varience of DS1 absolute change
var_DS1=0
old_data=DS1[1]
for(i in 1:len_DS1)
{
  var_DS1=var_DS1+((DS1[i]-old_data)-mean_DS1)^2
  old_data=DS1[i]
}
var_DS1=var_DS1/(len_DS1-1)
print(paste("varience DS1 of absolute change=",var_DS1))
#var_DS1=var(DS1) -->variance using built in function



##mean and varience for DS2 absolute change
#mean of DS2 absolute change
mean_DS2=0
old_data=DS2[1]
for(i in 1:len_DS2)
{
  mean_DS2=mean_DS2+(DS2[i]-old_data)
  
  old_data=DS2[i]
  
}
mean_DS2=mean_DS2/len_DS2
print(paste("Mean DS2 of absolute change=",mean_DS2))
#mean_DS2=mean(DS2)-->mean using built in function

#varience of DS2 absolute change
var_DS2=0
old_data=DS2[1]
for(i in 1:len_DS2)
{
  var_DS2=var_DS2+((DS2[i]-old_data)-mean_DS2)^2
  old_data=DS2[i]
}
var_DS2=var_DS2/(len_DS2-1)
print(paste("varience DS2 of absolute change=",var_DS2))
...
print(paste("Mean both dataset of absolute change=",mean_DS1_Ds2))
...
print(paste("varience both dataset of absolute change=",var_DS1_Ds2))
...
print(paste("skewness of DS1=",skewness_DS1))
...
print(paste("kurtosis of DS1=",kurtosis_DS1))
